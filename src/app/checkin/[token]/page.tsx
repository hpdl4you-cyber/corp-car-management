      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="bg-white rounded-xl shadow p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-500 text-sm">
            체크인 시각: {formatDateTime(row.checkinAt)}
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="bg-white rounded-xl shadow p-8 max-w-md w-full">
        <div className="flex items-center gap-3 mb-6">
          ...
          />
          <div>
            <h1 className="text-xl font-bold text-gray-900">체크인</h1>
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-6 space-y-2 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium">{formatDateTime(row.startAt)}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-500">종료</span>
            <span className="font-medium">{formatDateTime(row.endAt)}</span>
          </div>
          {row.purpose && (
            <div className="flex justify-between">
